 ...
 * scoping helper (`@metrock/backend-common`'s `forTenant`) — see
 * procurement-service's copy of this file for the full rationale on why
 * this thin per-service subclass exists instead of one fully-shared class.
 */
@Injectable()
